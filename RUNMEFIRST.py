...
c.execute("""CREATE TABLE banklist(bankname TEXT, bankid INTEGAR, interest INTEGAR, totalmoney INTEGAR, conversionrate INTEGAR)""")
c.execute("""CREATE TABLE blackmarket(fee INTEGAR, moneyleft INTEGAR, auth_key INTEGAR)""")

c.execute("""INSERT INTO banklist VALUES("찬우은행", 1, 0, 0, 0)""")
c.execute("""INSERT INTO banklist VALUES("국민은행", 2, 0, 0, 0)""")
